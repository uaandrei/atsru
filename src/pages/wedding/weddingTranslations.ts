...
export const weddingTranslations: Record<WeddingLocale, WeddingTranslation> = {
  ...
  hu: {
    ...
    location: {
      ...
      description:
        'Ezért az esküvőnk megünnepléséhez egy laza, természetközeli helyet választottunk a tó partján. Nem egy klasszikus esküvőt álmodtunk meg, hanem egy fergeteges bulit a kedvenc zenéinkkel és a számunkra legkedvesebb emberekkel.',
    ...
    rsvp: {
      ...
      deadlinePrefix: 'Kérjük, részvételi szándékotokat legkésőbb jelezzétek',

...
export function PictureUpload({ state, upload, t }: PictureUploadProps) {
  ...
  if (state.status === "done") {
    return (
      <div className="flex flex-col items-center gap-8">
        <div className="font-display font-bold text-4xl md:text-6xl" style={{ color: HEART_RED }}>
          Mulțumim! Köszönjük szépen!
        </div>
...
function CameraIcon({ color }: { color: string }) {
  return (
    <svg width={80} height={80} viewBox="0 -960 960 960" fill={color} aria-hidden focusable="false">

...
export const weddingTranslations: Record<WeddingLocale, WeddingTranslation> = {
  ro: {
    ...
    location: {
      ...
      mapLabel: 'Locația The Dallas Barn pe hartă',
      mapCta: 'Cum ajungeți?',
    },
    church: {
  ...
  hu: {
    ...
    schedule: {
      ...
      events: [
        ...
        { time: '16:00', title: 'Lakodalom', icon: 'celebration' },
      ],
    },
    location: {
      imageAlts: [
      ...
      title: 'Helyszín',
      venueName: 'The Dallas Barn',
      intro: 'Szeretjük a természetet, a táncot, a jó hangulatot és a veletek együtt töltött pillanatokat.',
      description:
        'Ezért az esküvőnk megünneplésére egy nyugodt, természetközeli helyet választottunk egy tó partján. Nem klasszikus esküvőt képzeltünk el, hanem egy igazán jó bulit a kedvenc zenéinkkel és azokkal az emberekkel, akik a legkedvesebbek számunkra.',
      tipsTitle: 'Fontos tudnivalók',
      tips: [
        {
          icon: 'hiking',
          text: 'A terep miatt, és hogy reggelig kényelmesen tudjatok táncolni, a kényelmes cipő lesz a legjobb választás.',
        },
        {
          icon: 'directions_car',
          text: 'Ha lehet, hagyjátok az autót a szállásnál. Bár van elegendő parkolóhely, azt javasoljuk, ne tervezzetek vezetni.',
        },
        {
          icon: 'directions_bus',
          text: 'A Segesvár–helyszín útvonalon a szállításról mi gondoskodunk.',
        },
      ],
    ...
    rsvp: {
      ...
      deadlinePrefix: 'Kérjük, jelezzetek vissza legkésőbb',
      deadlineDate: '2026. július 13-ig',
      deadlineSuffix: '.',
      ...
      attending: 'Igen',
      declining: 'Sajnos nem tudunk részt venni',
      namesLabel: 'Hányan érkeztek?',
      namesHelp:
        'Kérjük, írjátok meg a neveiteket, és ha gyerekkel/gyerekekkel érkeztek, az életkorát/életkorukat is.',
      namesPlaceholder: 'Pl.: Kovács János, Kovács Mária, Zsófi (5 éves)',
      accommodationQuestion: 'Szeretnétek, hogy szállást foglaljunk nektek Segesváron?',
      accommodationOptions: [
        { value: 'sat-sun', label: 'Igen — augusztus 8–9. (egy éjszaka, szombat–vasárnap)' },
        { value: 'fri-sun', label: 'Igen — augusztus 7–9. (két éjszaka, péntek–vasárnap)' },
        { value: 'none', label: 'Nincs rá szükség, megoldjuk.' },
      ],
      accommodationInfo:
        'Segesvár népszerű turistacélpont, és mivel kisváros, a szálláshelyek gyorsan betelnek. Érdemes időben foglalni.',
      dietaryLabel: 'Ételallergia vagy speciális étrend?',
      dietaryPlaceholder: 'pl.: gluténmentes, vegetáriánus...',
      messageLabel: 'Szeretnétek még valamit üzenni nekünk?',
    ...
    contact: {
      title: 'Kapcsolat',
      body: 'Ha bármilyen kérdésetek van, keressetek minket bátran!',
    },
  },
}
